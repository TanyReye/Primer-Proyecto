class Program 
{
    static void Main()
    {
        ...
        int total = 0; //para contenidos
        int publicados = 0; //publicados
        int rechazados = 0; //rechazados
        int revision = 0; //para revision
        ...
        do
        {
            ...
            } //si no es un numero lo pide de nuevo
            ...
            switch (menu)
            {
                case 1: //evaluar nuevo contenido
                    ...
                    total++; //suma uno al total de contenidos evaluados

                    bool valido = true; //si esta bien
                    bool ajuste = false; //para arreglos minimos
                    string razon = " "; //explicacion breve
                    ...
                    {
                        Console.WriteLine("Ingrese número valido."); //si no es numero o decimal lo pide de nuevo
                    }
                    ...
                    {
                        Console.WriteLine("Ingrese número valido."); //si no es numero lo pide de nuevo 
                    }
                    ...
                    {
                        if (!(horaContenido >= 6 && horaContenido <= 22)) //solo valido entre 6 y 22
                        {
                            if (horaContenido == 5 || horaContenido == 23) // si es 5 o 23 ajuste minimo
                            {
                                ajuste = true;
                            ...
                            {
                                valido = false;
                                razon = "Horario invalido para +13"; //si no invalido
                            }
                        }
                    }
                    ...
                    string impacto = "Bajo"; //variable impacto, por defecto bajo

                    if (produccionContenido == "alto" || duracionContenido > 120 || (horaContenido >= 20 && horaContenido <= 23))
                    {
                        impacto = "Alto";
                        impactoAlto++; //si cumple algo es impacto alto
                    }
                    ...
                    {
                        impactoBajo++; //bajo, si no cumple nada
                    }




                    if (impacto == "Alto") //va a revision
                    {
                        revision++;
                        Console.WriteLine(" ");
                    ...
                    else //se publica
                    {
                        ...
                        {
                            Console.WriteLine("Publicar."); //resultado final sin ajustes
                ...
                case 2: 
                    MostrarReglas(); //lama a una funcion que imprime reglas
                    break;
                ...
                Console.WriteLine(" "); 
                    ...
                    for (int i = 0; i < 1; i++)
                    {
                        Console.WriteLine("Fin de estadísticas. "); //se escribira una sola vez
                    } 
                ...
                case 4: //reiniciar
                    ...
                    impactoAlto = 0;
                    impactoMedio = 0;
                    impactoBajo = 0; //para reinciar todos los datos se vuelven 0
        ...
        static void MostrarReglas() //funcion de reglas
        {
